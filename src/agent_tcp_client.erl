...
-type(persistant_ring_option() :: 'persistant_ring').
-type(start_option() :: 
	server_option() |
	port_option() | 
	username_option() | 
...
init(Options) ->
	...
	Persistance = proplists:get_value(persistant_ring, Options),
	...
	case Hint of
		...
		'GET_SALT' ->
			...
			LoginRequest = #loginrequest{
				...
				use_persistant_ring = Options#options.persistant_ring
			},
