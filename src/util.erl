...
-spec(chomp_test/0 :: () -> any()).
chomp_test() ->
	?assertEqual("Fooo", string_chomp("Fooo\r\n")).
	
-spec(list_contains_all_test/0 :: () -> any()).
...
-spec(subtract_skill_lists_test/0 :: () -> any()).
