...
this._menuChildren={};
this._btnWidth=0;
this._buttons=dojo.query("> .tabStripButton",this.domNode).filter(function(_8){
if((this.useMenu&&_8==this._menuBtn.domNode)||(this.useSlider&&(_8==this._rightBtn.domNode||_8==this._leftBtn.domNode))){
this._btnWidth+=dojo.marginBox(_8).w;
return true;
}else{
...
if(_9.length){
var _a=_9[this.isLeftToRight()?0:_9.length-1].domNode,_b=_9[this.isLeftToRight()?_9.length-1:0].domNode;
return _b.offsetLeft+dojo.style(_b,"width")-_a.offsetLeft;
}else{
return 0;
}
},_enableBtn:function(_c){
var _d=this._getTabsWidth();
_c=_c||dojo.style(this.scrollNode,"width");
return _d>0&&_c<_d;
},resize:function(_e){
...
this._contentBox=dijit.layout.marginBox2contentBox(this.domNode,{h:0,w:_e.w});
this._contentBox.h=this.scrollNode.offsetHeight;
dojo.contentBox(this.domNode,this._contentBox);
var _f=this._enableBtn(this._contentBox.w);
this._buttons.style("display",_f?"":"none");
...
var _10=dojo.style(this.containerNode,"width")-dojo.style(this.scrollNode,"width");
return (dojo.isIE==8?-1:1)*(val-_10);
}
},onSelectChild:function(_11){
var tab=this.pane2button[_11.id];
if(!tab||!_11){
return;
}
var _12=tab.domNode;
if(_12!=this._selectedTab){
this._selectedTab=_12;
var sl=this._getScroll();
if(sl>_12.offsetLeft||sl+dojo.style(this.scrollNode,"width")<_12.offsetLeft+dojo.style(_12,"width")){
var _13=this.createSmoothScroll();
dojo.connect(_13,"onEnd",function(){
tab.onClick(null);
});
_13.play();
}else{
